  ...
  return (
    <div className={cn("px-4 pb-4", isMobile ? "pt-14" : "pt-20")}>
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-gray-500">@daviddubois_ethics</p>
        <p className={cn("text-gray-900 mt-2", isMobile ? "text-sm" : "text-base")}>
          Writer | Digital rights & AI ethics<br/>
          Exploring how tech reshapes privacy, power & trust.
        </p>
        ...
        <div className="flex flex-wrap items-center gap-3 text-gray-500 text-sm mt-2">
          ...
          <div className="flex items-center">
            ...
            <a href="#" className="text-twitter-blue hover:underline">ethicstech.blog</a>
          </div>
          <div className="flex items-center">
